...
void UOnlinePicoSettings::SaveSettings()
{
    ...
    FString Nul = TEXT("Null");

    if (bEnabled)
    {
        GConfig->SetString(TEXT("OnlineSubsystem"), TEXT("DefaultPlatformService"), *Nul, FPaths::ProjectDir() + "Config/DefaultEngine.ini");
        GConfig->SetString(TEXT("OnlineSubsystem"), TEXT("DefaultPlatformService"), *Nul, FPaths::ProjectDir() + "Config/Android/AndroidEngine.ini");
    }
