...
bool FOnlineIdentityPico::GetLoginUserAndRoom(int32 LocalUserNum, const FOnGetUserAndRoomDelegate& Delegate /*= FOnGetUserAndRoomDelegate()*/)
{
#if PLATFORM_ANDROID
#endif
    return false;
...
void FOnlineIdentityPico::OnGetUserAndroomComplete(ppfMessageHandle Message, bool bIsError, int32 LcoalUserNum, const FOnGetUserAndRoomDelegate& Delegate)
{
#if PLATFORM_ANDROID
#endif
}

void FOnlineIdentityPico::OnGetAccessTokenComplete(ppfMessageHandle Message, bool bIsError, int32 LocalUserNum)
{
    // Not implemented
}
