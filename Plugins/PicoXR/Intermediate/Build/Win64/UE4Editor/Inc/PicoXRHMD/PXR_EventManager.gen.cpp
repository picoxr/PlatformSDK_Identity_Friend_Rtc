...
// Cross Module References
	...
	PICOXRHMD_API UFunction* Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature();
...
// End Cross Module References
	...
	struct Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics
	{
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::NewProp_trackingStage = { "trackingStage", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PicoXRHMD_eventPXRHandMenuPressedDelegate_Parms, trackingStage), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::NewProp_trackingStageProcess = { "trackingStageProcess", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_PicoXRHMD_eventPXRHandMenuPressedDelegate_Parms, trackingStageProcess), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::NewProp_trackingStage,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::NewProp_trackingStageProcess,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Private/PXR_EventManager.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PicoXRHMD, nullptr, "PXRHandMenuPressedDelegate__DelegateSignature", nullptr, nullptr, sizeof(_Script_PicoXRHMD_eventPXRHandMenuPressedDelegate_Parms), Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_HandMenuPressedDelegate_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_HandMenuPressedDelegate;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPicoXREventManager_Statics::NewProp_HandMenuPressedDelegate_MetaData[] = {
		{ "ModuleRelativePath", "Private/PXR_EventManager.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPicoXREventManager_Statics::NewProp_HandMenuPressedDelegate = { "HandMenuPressedDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPicoXREventManager, HandMenuPressedDelegate), Z_Construct_UDelegateFunction_PicoXRHMD_PXRHandMenuPressedDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UPicoXREventManager_Statics::NewProp_HandMenuPressedDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPicoXREventManager_Statics::NewProp_HandMenuPressedDelegate_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPicoXREventManager_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPicoXREventManager_Statics::NewProp_HandMenuPressedDelegate,
	};
	...
	IMPLEMENT_CLASS(UPicoXREventManager, 2297443761);
