...
// Cross Module References
	PICOXRHMD_API UEnum* Z_Construct_UEnum_PicoXRHMD_EHandTrackingSupport();
...
// End Cross Module References
	static UEnum* EHandTrackingSupport_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_PicoXRHMD_EHandTrackingSupport, Z_Construct_UPackage__Script_PicoXRHMD(), TEXT("EHandTrackingSupport"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EHandTrackingSupport(EHandTrackingSupport_StaticEnum, TEXT("/Script/PicoXRHMD"), TEXT("EHandTrackingSupport"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_PicoXRHMD_EHandTrackingSupport_Hash() { return 2715388052U; }
	UEnum* Z_Construct_UEnum_PicoXRHMD_EHandTrackingSupport()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_PicoXRHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EHandTrackingSupport"), 0, Get_Z_Construct_UEnum_PicoXRHMD_EHandTrackingSupport_Hash(), false);
#else
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPicoXRSettings_Statics::NewProp_HandTrackingSupport = { "HandTrackingSupport", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPicoXRSettings, HandTrackingSupport), Z_Construct_UEnum_PicoXRHMD_EHandTrackingSupport, METADATA_PARAMS(Z_Construct_UClass_UPicoXRSettings_Statics::NewProp_HandTrackingSupport_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPicoXRSettings_Statics::NewProp_HandTrackingSupport_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UPicoXRSettings, 449111560);
