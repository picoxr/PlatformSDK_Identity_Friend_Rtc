...
static struct FScriptStruct_PicoXRHMD_StaticRegisterNativesFPxrSensorState
{
	...
	DEFINE_FUNCTION(UPicoXRHMDFunctionLibrary::execPXR_GetFaceTrackingData)
	{
		...
		P_GET_TARRAY_REF(float,Z_Param_Out_BlendShapeWeight);
		P_GET_TARRAY_REF(float,Z_Param_Out_Reserved);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UPicoXRHMDFunctionLibrary::PXR_GetFaceTrackingData(Z_Param_Ts,Z_Param_Flags,Z_Param_Out_TimeStamp,Z_Param_Out_BlendShapeWeight,Z_Param_Out_Reserved);
		P_NATIVE_END;
	}
	...
	void UPicoXRHMDFunctionLibrary::StaticRegisterNativesUPicoXRHMDFunctionLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PXR_GetFaceTrackingData", &UPicoXRHMDFunctionLibrary::execPXR_GetFaceTrackingData },
	...
	struct Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics
	{
		struct PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms
		{
			int64 Ts;
			int32 Flags;
			int64 TimeStamp;
			TArray<float> BlendShapeWeight;
			TArray<float> Reserved;
			bool ReturnValue;
		};
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_BlendShapeWeight_Inner;
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_BlendShapeWeight;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Reserved_Inner;
	...
	const UE4CodeGen_Private::FInt64PropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Ts = { "Ts", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms, Ts), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Flags = { "Flags", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms, Flags), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FInt64PropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_BlendShapeWeight_Inner = { "BlendShapeWeight", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_BlendShapeWeight = { "BlendShapeWeight", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms, BlendShapeWeight), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Reserved_Inner = { "Reserved", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Reserved = { "Reserved", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms, Reserved), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms*)Obj)->ReturnValue = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms), &Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Ts,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Flags,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_TimeStamp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_BlendShapeWeight_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_BlendShapeWeight,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Reserved_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_Reserved,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::Function_MetaDataParams[] = {
		{ "Category", "PXR|PXRHMD" },
		{ "ModuleRelativePath", "Public/PXR_HMDFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPicoXRHMDFunctionLibrary, nullptr, "PXR_GetFaceTrackingData", nullptr, nullptr, sizeof(PicoXRHMDFunctionLibrary_eventPXR_GetFaceTrackingData_Parms), Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPicoXRHMDFunctionLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_EnableEyeTracking, "PXR_EnableEyeTracking" }, // 2885202007
		...
		{ &Z_Construct_UFunction_UPicoXRHMDFunctionLibrary_PXR_GetFaceTrackingData, "PXR_GetFaceTrackingData" }, // 2978040565
	...
	IMPLEMENT_CLASS(UPicoXRHMDFunctionLibrary, 435263196);
