...
struct PICOXRMR_API FAnchorLoadResult
{
	...
	FAnchorLoadResult(): PersistLocation(EPICOPersistLocation::PersistLocation_Local)
	{
	}
};
...
struct FPICOMRSceneInfo
{
	...
	FPICOMRSceneInfo(): Semantic(EPICOSemanticLabel::Unknown), SceneType(EPICOSceneType::BoundingBox2D)
	{
	}
};
...
struct FPICOUVAdjustment
{
	...
	FPICOUVAdjustment(): Offset(FVector2D::ZeroVector), Scale(FVector2D::UnitVector), Rotation(0.0f)
	{
	}
};
...
struct FPICOMRBox2DInfo_Offline
{
	...
	FPICOMRBox2DInfo_Offline(): Offset(FVector2D::ZeroVector), Extent(FVector2D::ZeroVector)
	{}
};
...
struct FPICOMRBox3DInfo_Offline
{
	...
	FPICOMRBox3DInfo_Offline(): Offset(FVector::ZeroVector), Extent(FVector::ZeroVector)
	{}
};
...
struct FPICOMRSceneInfo_Offline
{
	...
	FPICOMRSceneInfo_Offline(): Position(FVector::ZeroVector), Rotation(FQuat::Identity), SemanticLabel(EPICOSemanticLabel::Unknown)
	{
	}
