...
public: 
	...
	const UPicoXRSettings* GetPicoXRSettings();
...
private:
	...
	void UpdateGlobalHandState();
	void UpdateInputActivation();
	void SetMotionControllersActive(bool Active);
	...
	EPicoXRActiveInputDevice CurrentInputDevice;
	EPicoXRActiveInputDevice ActiveInputDevice;
};
