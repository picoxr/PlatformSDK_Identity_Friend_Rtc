...
public:
	...
	//virtual void RenderTexture_RenderThread(FRDGBuilder& GraphBuilder, class FRHITexture* BackBuffer, class FRHITexture* SrcTexture, FVector2D WindowSize) const override;
  ...
  /** FXRRenderTargetManager interface */
	...
	uint32 CreateMRCStereoLayer(UTextureRenderTarget2D* BackgroundRTTexture, UTextureRenderTarget2D* ForegroundRTTexture);
